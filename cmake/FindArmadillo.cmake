...
find_path (ARMADILLO_DIR "ArmadilloConfig.cmake"  DOC "Path to ArmadilloConfig.cmake which is normally in the installation or build folder")

if (WIN32)
	find_path( ARMADILLO_DIR "lib/armadillo.lib" PATHS "C:/*/" "C:/*/*/")
else (WIN32)
	find_path( ARMADILLO_DIR "CMake/ArmadilloConfig.cmake" PATHS "/usr/local/*/" "/usr/local/share/*/" "/usr/local/lib/*/*/*/" "/opt/*/" "/opt/*/*/")
endif (WIN32)

#find_library(ARMADILLO_LIBRARY
# 		     NAMES armadillo
#  		     PATHS ${ARMA} "$ENV{ProgramFiles}/Armadillo/lib"  "$ENV{ProgramFiles}/Armadillo/lib64" "$ENV{ProgramFiles}/Armadillo"
#  	)
#	find_path(ARMADILLO_INCLUDE_DIR
# 		  NAMES armadillo
#  		  PATHS  ${ARMADILLO_WIN_INCLUDE_DIR} "$ENV{ProgramFiles}/Armadillo/include"
#  	)
                                       

if (ARMADILLO_DIR)

  file( GLOB_RECURSE ARMADILLO_CONFIG_DIR  "${ARMADILLO_DIR}/*/ArmadilloConfig.cmake")
  get_filename_component(ARMADILLO_CONFIG_DIR "${ARMADILLO_CONFIG_DIR}" PATH)

	message (STATUS "Open Armadillo configuration file")
	include ("${ARMADILLO_CONFIG_DIR}/ArmadilloConfig.cmake")
	
	if (ARMADILLO_INCLUDE_DIRS )
		set (ARMADILLO_FOUND true )
		set (ARMADILLO_INCLUDE_DIR ${ARMADILLO_INCLUDE_DIRS} CACHE PATH "")
                #if (WIN32)
                #	file( GLOB_RECURSE ARMADILLO_LIBRARY  "${ARMADILLO_DIR}/*/armadillo*.lib")
                #else (WIN32)
                #       file( GLOB_RECURSE ARMADILLO_LIBRARY  "/usr/local/lib/*armadillo*.a")
                #endif (WIN32)
                #set (ARMADILLO_LIBRARY "armadillo" CACHE STRING "")
    set (ARMADILLO_LIBRARY "armadillo")
